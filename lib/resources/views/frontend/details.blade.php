            ...
            <div class="row">
                <div id="product-img" class="col-xs-12 col-sm-12 col-md-3 text-center">
                    ...
                    <div style="display: flex; align-items: center ; gap: 8px; justify-content: center; margin-top:7px;">
                        ...
                        @endif
                        <span class="favorite-text">Liked({{ $count }})</span>
                     </div>
                </div>
                <div id="product-details" class="col-xs-12 col-sm-12 col-md-9">
                    <p>Price: <span class="price">{{ number_format($product->prod_price,0,',','.' )}} VND</span></p>
                    <p>Condition: {{ $product->prod_condition }}</p>
                    <p class="add-cart text-center"><a href="{{ asset('cart/add/' . $product->prod_id) }}">Add to Cart</a></p>
                </div>
            </div>
        </div>
