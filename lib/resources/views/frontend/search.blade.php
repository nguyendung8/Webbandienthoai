...
@section('main')
    ...
    <div id="wrap-inner">
        <div class="products">
            ...
            <h3 style="text-align: center; margin-bottom: 10px;">Product list according to search request</h3>
            <div style="gap: 15px;" class="product-list row">
                ...
                <div style="border-radius: 10px;" class="product-item col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="marsk">
                        <a href="{{ asset('/detail/' . $item->prod_id) }}">View details</a>
                    </div>
                </div>
                @endforeach
            ...
            @else
                ...
                <p style="font-size: 30px; text-align: center;">No products match your search request</p>
            @endif
        </div>
    </div>
@stop
