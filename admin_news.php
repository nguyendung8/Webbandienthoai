<?php
   ...
   if(isset($_POST['add_product'])){//thêm tin tức mới từ submit form name='add_employee'
      ...
      $add_new_query = mysqli_query($conn, "INSERT INTO `news`(image, content) VALUES('$image', '$content')") or die('query failed');
   ...
   if(isset($_GET['delete'])){//xóa tin tức từ onclick <a></a> href='delete'
      $delete_id = $_GET['delete'];
      $delete_image_query = mysqli_query($conn, "SELECT image FROM `news` WHERE id = '$delete_id'") or die('query failed');
   ...
   if(isset($_POST['update_new'])){//cập nhật sản phẩm từ form submit name='update_new'

      $update_new_id = $_POST['update_new_id'];
      $update_content = $_POST['update_content'];

      mysqli_query($conn, "UPDATE `news` SET content = '$update_content' WHERE id = '$update_new_id'") or die('query failed');
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="content" class="box" placeholder="Nội dung" required>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      ?>
               <div class="box">
                  <img  style="height: 26rem !important;" style="border-radius: 4px;" src="uploaded_img/<?php echo $fetch_news['image']; ?>" alt="">
...
<section class="edit-product-form">
   ...
   ?>
               <form action="" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="update_new_id" value="<?php echo $fetch_update['id']; ?>">
                  ...
                  <input type="submit" value="update" name="update_new" class="btn">
                  <a href="./admin_news.php"> <p class="option-btn">Cancel</p></a>
               </form>
   <?php
            }
         }
